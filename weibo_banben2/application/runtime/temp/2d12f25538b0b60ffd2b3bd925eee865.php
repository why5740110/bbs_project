        ...
        <div id="top">
            <div class='top_wrap'>
                ...
                <div id="search" class='fleft'>
                    <form action='<?php echo U("Search/person/index"); ?>' method='get' target="_blank">
            ...
            <div class="weibo">
                ...
                <div class="face">
                    <a href="<?php echo U('Person/index'); ?>">
                        <img style="border-radius:100px;"   src="<?php echo APP_PUBLIC; ?>/uploads/txpic/<?php echo $userdetail['picname']; ?>" width='50' height='50'/>
                    </a>
                </div>
                <div class="wb_cons">
                    <dl>
                    <!--用户名-->
                        <dt class='author'>
                            <a href="<?php echo U('Person/index'); ?>"><?php echo $vo['nickname']; ?></a>
                        </dt><br>
                    <!--发布内容-->
                        <dd class='content'>
                    ...
                    <!--发布时间-->
                        ...
                        <div>
                            <ul>
                                ...
                                <li><span class='comment' test="show" data="<?php echo $vo['id']; ?>" url="<?php echo U('Indexajax/showpinlun'); ?>"><span>评论</span> <a class="pls"><?php echo $vo['count_reply']; ?></a></span></li>
...
<!--==========右侧==========-->
        ...
        <div id="right">
            ...
            <dl class="user_face">
                <dt>
                    <a href="<?php echo U('Person/index'); ?>"><img style="border-radius:100px;width:60px;height:60px;" src="<?php echo APP_PUBLIC; ?>/uploads/txpic/<?php echo $userdetail['picname']; ?>" width='80' height='80' alt="" /></a>
                </dt>
                    ...
                    <ul>
                        <?php if(!empty($hyxx)): foreach($hyxx as $vo): ?>
                            <li>
                                <dl>
                                    <dt>
                                        <a href="<?php echo U('Persongz/index'); ?>?uid=<?php echo $vo['uid']; ?>"><img style="border-radius:100px;" src="<?php echo APP_PUBLIC; ?>/uploads/txpic/<?php echo $vo['picname']; ?>" alt="" width='30' height='30'/></a>
                                    </dt>
...
<!--==========底部==========-->
    <div style="margin:0 auto;width:980px;">
        <a href="<?php echo $guanggao_list_buttom['link']; ?>" target="_blank"><img width="980" src="<?php echo APP_PUBLIC; ?>/uploads/guanggao/<?php echo $guanggao_list_buttom['imagename']; ?>" alt=""/></a>
    </div>
    <div id="bottom">
        <div class='link' width="100%">
            <?php if(empty($linkList)): foreach($linkList as $linkList): ?>
