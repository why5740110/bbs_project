...
<!--/二级导航-->        <!--/二级导航-->
	 ...
	 <div class="F_rows_main"> 
      <div class="F_cols_main">
		...
		<br>
            <div class="phto_count M_txta" node-type="photos_info">他的照片<span>(共<?php echo $pic_count; ?>张)</span></div><div class="browse_type"><!-- <a class="M_linke M_slide_sm" href="http://photo.weibo.com/2664098951/photos#" action-type="slide_open"><span class="M_ico M_icon12"></span>幻灯浏览</a> --></div>
        </div>
        <!--/幻灯浏览-->
				...
				<li action-data="pid=3642504728738567&amp;aid=3423857315111989&amp;type=2">
					<dl class="m_photoItem m_photoItem_a">
						<dt class="photo myphoto" style="border:1px solid #ccc;">
							<a href="<?php echo U('Picgz/picshow'); ?>?picid=<?php echo $vt['id']; ?>&uid=<?php echo $vt['uid']; ?>&photoid=<?php echo $vt['photo_id']; ?>" title="">
						...
						<dd>
							...
							<!-- <div class="edit_tip">
								...
								<a href="<?php echo U('Pic/del'); ?>?picid=<?php echo $vt['id']; ?>&uid=<?php echo $vt['uid']; ?>" action-type="photo_del">删除</a>
							</div> -->
						</dd>
					</dl>
				</li>
