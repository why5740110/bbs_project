				...
				<?php foreach($res as $key=>$v): ?>
					<li class="dzan_user" style="height:60px;width:980;border-bottom:1px solid #ccc;padding-left:10px;margin-top:5px;position:relative">
						...
						<a href="<?php echo U('pic/index'); ?>">
							<img class="userimage" src="<?php echo APP_INDEX; ?>uploads/txpic/<?php echo $userlist[$key]['picname']; ?>" width=50px alt="头像" style="float:left;">
						</a>
						<span style="margin-left:10px;">我已赞了 <a href="<?php echo U('Picgz/index'); ?>?uid=<?php echo $key; ?>"><?php echo $username[$key]['username']; ?></a> 的照片</span>
					...
					<!-- 用户：<?php echo $key; ?><br>
					照片：
					<?php foreach($res[$key] as $b): echo $b; ?><br>
					<?php endforeach; ?> -->
				<?php endforeach; ?>
