<?php if (!defined('THINK_PATH')) exit();?><form id="pagerForm" action="<?php echo U('Weibo/index'); ?>" method="post">
	...
	<input type="hidden" name="_order" value="<?php echo (isset($_REQUEST['_order']) && ($_REQUEST['_order'] !== '')?$_REQUEST['_order']:'time'); ?>"/>
	<input type="hidden" name="_sort" value="<?php echo (isset($_REQUEST['_sort']) && ($_REQUEST['_sort'] !== '')?$_REQUEST['_sort']:'desc'); ?>"/>
</form>
<div class="pageHeader">
	...
	<div class="searchBar">
		<table class="searchContent">
			<tr>
				<td>
					<b>搜索</b> &nbsp; 内容：<input type="text" name="keyword" size="6" value="<?php echo (isset($_POST['keyword']) && ($_POST['keyword'] !== '')?$_POST['keyword']:''); ?>" /> 
				</td>
                <td>
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="delete" href="<?php echo U('weibo/del'); ?>?id={item_id}&navTabId=weibolist" target="ajaxTodo" title="确定要加入回收站吗?"><span>放入回收站</span></a></li>
