...
<!--/二级导航-->        <!--/二级导航-->
	 ...
	 <div class="F_rows_main"> 
      <div class="F_cols_main">
		...
		<br>
            <div class="phto_count M_txta" node-type="photos_info">我的照片<span>(共<?php echo $pic_total; ?>张)</span></div><div class="browse_type"><!-- <a class="M_linke M_slide_sm" href="http://photo.weibo.com/2664098951/photos#" action-type="slide_open"><span class="M_ico M_icon12"></span>幻灯浏览</a> --></div>
        </div>
        <!--/幻灯浏览-->
        ...
        <div class="m_photo_list_a" node-type="photo_list">
			...
			<ul class="photoList clearfix">
				<?php foreach($pic_list as $vo): ?>
				<li  action-data="pid=3642504728738567&amp;aid=3423857315111989&amp;type=2" >
					
					<dl class="m_photoItem m_photoItem_a">
						<dt class="photo myphoto" >
							<a href="<?php echo U('Pic/picshow'); ?>?picid=<?php echo $vo['id']; ?>&uid=<?php echo $vo['uid']; ?>&photoid=<?php echo $vo['photo_id']; ?>" title="图片">
						...
						<dd class="ppicid">
							...
							<p class="photoid" style="display:none;"><?php echo $vo['photo_id']; ?></p>
