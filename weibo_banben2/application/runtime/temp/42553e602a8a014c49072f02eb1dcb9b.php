...
<!--====================转发样式结束====================-->
<?php endforeach; endif; ?>
            <div test="<?php echo U('Indexajax/article'); ?>" class='fenye' data="<?php echo $p; ?>"></div>
            <span class="end"></span>
        </div>
<!-- 瀑布流 -->
    ...
    $(function(){
        $(window).bind("scroll", function(){
            ...
            var top = $(this).scrollTop()+20;
                ...
                var oldp = $(".fenye").attr("data");
                var zuihou = $(".fenye:last").text(oldp);
                var url = $(".fenye:last").attr("test");
                    $.ajax({
                        url:url,
                        type:'post',
                        data:{p:oldp},
