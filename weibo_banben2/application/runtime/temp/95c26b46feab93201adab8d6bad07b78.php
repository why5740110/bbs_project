    ...
    <!--/简易顶部导航拼页面用-->
        	...
        	<div class="WB_frame_a">
				...
				<div class="shadow  S_shadow" layout-shell="false" >
						...
						<div class="pf_intro" title="用户所在地" style="font-size:30px;"><?php echo $userlist['address']; ?></div>
											</div>
...
<div node-type="moreList" class="layer_menu_list_b" style="position:absolute; top:332px; left:900px; z-index:999;display: none;">	
						...
						<table class="tb_counter" cellpadding="0" cellspacing="0">
							<tbody>
								<tr>
									...
									<td class="S_line1">
										<a bpfilter="page_frame" class="t_link S_txt1" href="http://weibo.com/p/1005052664098951/home?from=page_100505_profile&wvr=6&mod=data#place"><strong class="W_f18">55</strong><span class="S_txt2">微博</span></a>
									</td>
								</tr>
							</tbody>
						</table>
	...
	<div class="PCD_person_info">
		...
		<a class="WB_cardmore S_txt1 S_line1 clearfix" href="<?php echo U('Persongz/pdetails'); ?>?uid=<?php echo $uname['id']; ?>" bpfilter="page_frame" ontouchstart="">
	<span class="more_txt">查看个人资料&nbsp;<em class="W_ficon ficon_arrow_right S_ficon"></em></span>
</a>
