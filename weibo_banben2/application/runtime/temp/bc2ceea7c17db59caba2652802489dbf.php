...
<!--/二级导航-->        <!--/二级导航-->
   ...
   <div class="F_main">
     <!--创建专辑-->
     <div class="m_browse_menu clearfix" node-type="album_info"><div class="tit M_txta">他的可见专辑列表<span class="M_txtb">(共<?php echo $gzphoto_pic_total; ?>个)</span></div><div class="album_count M_txta"><span class="creat">
	 ...
	 <!--页面class="myphoto"  的dt的js控制-->
		<script>
			$(function(){
				...
				$("a[action-type='album_shoucang']").click(function(){
					...
					//执行ajax传值
					$.ajax({
						url:"<?php echo U('Photo/photoshoucang'); ?>",
						type:"post",
      ...
      <div id="wb_photo" class="m_user_albumlist" node-type="album_list">
		<ul id="photolist_ul" class="albumlists clearfix">
			<?php foreach($gzphoto_list as $key=>$vo): ?>
			<li action-data="aid=3423857315111989&amp;property=1">
				<div class="m_fav_album">
					<div class="m_cover m_cover_c">
						<div class="img_wrap myphoto">
							<a title="<?php echo $vo['title']; ?>" href="<?php echo U('Picgz/photopic'); ?>?photoid=<?php echo $vo['id']; ?>&uid=<?php echo $vo['uid']; ?>" undefined="">
					...
					<div class="detail">
						...
						<p class="edit M_txtd">
							...
							<!-- <a href="<?php echo U('Photo/del'); ?>?id=<?php echo $vo['id']; ?>&uid=<?php echo $vo['uid']; ?>" action-type="album_del" action-data="album_id=3454582265827570">删除</a> -->
						</p>
		...
		<div style="text-align:center;font-size:18px;"><?php echo $photopageshow; ?></div>
	</div>
	<!--======================================-->
      <!--/用户专辑列表-->
      <!--翻页-->
