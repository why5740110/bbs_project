...
<html style="margin-top: 0px; margin-right: 0px;">
	...
	<script type="text/javascript" charset="utf-8" async="" src="<?php echo APP_INDEX; ?>common/person/person/exposure.js">
	</script>
	...
	<link rel="stylesheet" href="<?php echo APP_INDEX; ?>/common/person/person/nav.css" />
	...
	/*var $CONFIG = {};
	$CONFIG['islogin']='1'; 
	$CONFIG['oid']='2664098951'; 
	$CONFIG['page_id']='1005052664098951'; 
	$CONFIG['onick']='江西王红影'; 
	$CONFIG['skin']='skin019'; 
	$CONFIG['background']=''; 
	$CONFIG['scheme']='diy007'; 
	$CONFIG['colors_type']='1'; 
	$CONFIG['uid']='2664098951'; 
	$CONFIG['nick']='江西王红影'; 
	$CONFIG['sex']='m'; 
	$CONFIG['watermark']='u/2664098951'; 
	$CONFIG['domain']='100505'; 
	$CONFIG['lang']='zh-cn'; 
	$CONFIG['timeDiff']=(new Date() - 1456413879000); 
	$CONFIG['servertime']='1456413879'; 
	$CONFIG['location']='page_100505_home'; 
	$CONFIG['pageid']=''; 
	$CONFIG['title_value']='江西王红影的微博_微博'; 
	$CONFIG['$webim']='1'; 
	$CONFIG['miyou']='1'; 
	$CONFIG['brand']='0'; 
	$CONFIG['publish2000']='0'; 
	$CONFIG['bigpipe']='true'; 
	$CONFIG['bpType']='page'; 
	...
	$CONFIG['version']='b46d0ccc8cc49598'; 
	...
	<style>
		...
		#topding{width:41px;height:47px;background:url('<?php echo APP_INDEX; ?>common/person/person/top.png') no-repeat 0px 0px;position:fixed;right:20px;bottom:100px;display:none;}
		#topding:hover{background-position:0px -47px;}
    ...
    <div class="WB_global_nav WB_global_nav_alpha" node-type="top_all">
      <div class="gn_header clearfix">
        <div class="gn_logo" node-type="logo" data-logotype="logo" data-logourl="http://weibo.com?topnav=1&amp;mod=logo">
       	 <a bpfilter="main" href="javascript:void(0);" class="box" title="" node-type="logolink" suda-uatrack="key=topnav_tab&amp;value=weibologo">
        ...
        <div class="gn_position">
	        <div class="gn_nav">
	          <ul class="gn_nav_list">
	            ...
	            <li><a dot="pos55b9e1ad88ae4" href="#" nm="find" class="S_txt1" suda-uatrack="key=topnav_tab&amp;value=discover"><em class="W_ficon ficon_found S_ficon"></em><em class="S_txt1">发现</em></a></li>
	            <li><a href="#" nm="game" class="S_txt1" suda-uatrack="key=topnav_tab&amp;value=game"><em class="W_ficon ficon_game S_ficon"></em><em class="S_txt1">游戏</em></a></li>
	       ...
	       <!--  <div class="gn_set S_line1">
			  ...
			  <a dot="pos55baf61a68b21" href="javascript:void(0);" node-type="account" nm="account"><em class="W_ficon ficon_set S_ficon">*</em> </a>
    ...
    <!--/简易顶部导航拼页面用-->
        	...
        	<div class="WB_frame_a">
				...
				<div class="shadow  S_shadow" layout-shell="false" >
						...
						<div class="pf_intro" title="用户所在地" style="font-size:30px;"><?php echo $userdetail['address']; ?></div>
											</div>
...
<div node-type="moreList" class="layer_menu_list_b" style="position:absolute; top:332px; left:900px; z-index:999;display: none;">	
	...
	<div class="PCD_person_info">
				...
				<div class="detail">
					<ul class="ul_detail">
						...
						<!-- <li class="item S_line2 clearfix">
    						...
    						<span class="item_text W_fl">博客地址：
								<a target="_blank" href="http://blog.sina.com.cn/u/2664098951">http://blog.sina.com.cn/u/2664098951</a>
    						</span>
						</li> -->
					</ul>
				</div>
		...
		<a class="WB_cardmore S_txt1 S_line1 clearfix" href="<?php echo U('Person/pdetails'); ?>" bpfilter="page_frame" ontouchstart="">
	...
	<div id="Pl_Official_MyProfileFeed__24" anchor="-50">        <div class="WB_feed WB_feed_profile">
        ...
        <!--feed内容-->
            <div class="WB_feed WB_feed_profile" pagenum="" node-type="feed_list" module-type="feed">
				<div minfo="ru=5387168588&amp;rm=3885917867313445" tbinfo="ouid=2664098951&amp;rouid=5387168588" diss-data="" mid="3885937941045856" isforward="1" omid="3885917867313445" class="WB_cardwrap WB_feed_type S_bg2" action-type="feed_list_item">
							...
							<div class="screen_box"><a href="javascript:void(0);" action-type="fl_menu"><i class="W_ficon ficon_arrow_down S_ficon">c</i></a>
								<div class="layer_menu_list" style="display: none; position: absolute; z-index: 999;" node-type="fl_menu_right">
									<ul>
                                        ...
                                        <li><a action-type="fl_setToTop" href="javascript:void(0);" title="在微博区域置顶显示" suda-uatrack="key=profile_feed&amp;value=stickie_host">置顶</a></li>                                            
										<li><a href="javascript:void(0);" _taglist="" node-type="feed_list_addTag" action-type="fl_addTag" action-data="mid=3885937941045856" suda-uatrack="key=profile_feed&amp;value=addtag_host">加标签</a></li>
                                        <li><a href="javascript:;" action-type="fl_friendVisible" action-data="visible=2" suda-uatrack="key=profile_feed&amp;value=friendsonly_host">转换为好友圈可见</a></li>
										<li><a href="javascript:;" action-type="fl_personalVisible" action-data="visible=1" suda-uatrack="key=profile_feed&amp;value=meonly_host">转换为仅自己可见</a></li>
                                                                    </ul>
								</div>
							</div>
						</div>
						<div class="WB_detail">
							<div class="WB_text W_f14" node-type="feed_list_content">hao</div>
                            <div class="WB_feed_expand">
								...
								<div class="WB_expand S_bg1" node-type="feed_list_forwardContent">
									<div class="WB_info">
										<a suda-uatrack="key=feed_headnick&amp;value=transuser_nick:3885917867313445" node-type="feed_list_originNick" class="W_fb S_txt1" nick-name="英语必修班" bpfilter="page_frame" href="http://weibo.com/YYBXB?refer_flag=1005055010_" title="英语必修班" usercard="id=5387168588&amp;refer_flag=1005055010_">@英语必修班</a>
										<a target="_blank" href="http://verified.weibo.com/verify"><i title="微博个人认证 " class="W_icon icon_approve"></i></a>
										<a title="微博会员" target="_blank" href="http://vip.weibo.com/personal?from=main" action-type="ignore_list" suda-uatrack="key=profile_head&amp;value=member_guest"><em class="W_icon icon_member3"></em></a>
									</div>
									<div class="WB_text" node-type="feed_list_reason">大学生应该脱口而出的，背完，你的英语口语绝对不成问题。</div>
...
<!-- 特型广告feed -->
        ...
        <div class="media_box">
                                     <!-- img之间不能加空格 -->
                                                                                                <!-- 九宫格 -->
                <div node-type="fl_pic_list" action-data="uid=5387168588&amp;pic_ids=005SA0DWgw1evo63xgzyxj30c61rg106,005SA0DWgw1evo63xsk8ij30c61i2aet,005SA0DWgw1evo63ww9p8j30c61g3wjo,005SA0DWgw1evo63y8gogj30c61q8446,005SA0DWgw1evo63z26tvj30c61m2wkm,005SA0DWgw1evo63wbijbj30c61k8dm8,005SA0DWgw1evo63zkw2oj30c61okwlw,005SA0DWgw1evo6401uubj30c61liafj,005SA0DWgw1evo640htunj30c61s2n3j&amp;mid=3885917867313445&amp;pic_objects=&amp;object_ids=1042018%3Ae501db4c81e07a6f494f34a43c1683d8%2C1042018%3Ab991b8fe6e1667767c7a0f7f16628d26%2C1042018%3A92b749605295eb7cc6e0866bbae15a82%2C1042018%3Ab50b54b0d4472cace72b508f989e8bb0%2C1042018%3Ad04f10f7e10a9062ab011d0cff817b20%2C1042018%3Abe5aa460c666f41dacc91890c58b9b1a%2C1042018%3A8dd7ab3adc539bd5f226cfc906eb173d%2C1042018%3A74922841b5c4149d893b571067fdcda9%2C1042018%3Accbbafa6ead8a80000864931fa433d8c&amp;photo_tag_pids=&amp;photo_filter_ids=,,,,,,,,">
                    <ul class="WB_media_a WB_media_a_mn  WB_media_a_m9 clearfix">
                                                                                                <li class="WB_pic S_bg2 bigcursor">
                            <img class="bigcursor" src="<?php echo APP_INDEX; ?>common/person/person/005SA0DWgw1evo63xgzyxj30c61rg106.jpg" action-data="pic_id=005SA0DWgw1evo63xgzyxj30c61rg106" action-type="fl_pics" suda-uatrack="key=tblog_newimage_feed&amp;value=image_feed_unfold:3885917867313445:005SA0DWgw1evo63xgzyxj30c61rg106">                        </li>
                                                                                                    <li class="WB_pic S_bg2 bigcursor">
                            <img class="bigcursor" src="<?php echo APP_INDEX; ?>common/person/person/005SA0DWgw1evo63xsk8ij30c61i2aet.jpg" action-data="pic_id=005SA0DWgw1evo63xsk8ij30c61i2aet" action-type="fl_pics" suda-uatrack="key=tblog_newimage_feed&amp;value=image_feed_unfold:3885917867313445:005SA0DWgw1evo63xsk8ij30c61i2aet">                        </li>
                                                                                                    <li class="WB_pic S_bg2 bigcursor">
                            <img class="bigcursor" src="<?php echo APP_INDEX; ?>common/person/person/005SA0DWgw1evo63ww9p8j30c61g3wjo.jpg" action-data="pic_id=005SA0DWgw1evo63ww9p8j30c61g3wjo" action-type="fl_pics" suda-uatrack="key=tblog_newimage_feed&amp;value=image_feed_unfold:3885917867313445:005SA0DWgw1evo63ww9p8j30c61g3wjo">                        </li>
                                                                                                    <li class="WB_pic S_bg2 bigcursor">
                            <img class="bigcursor" src="<?php echo APP_INDEX; ?>common/person/person/005SA0DWgw1evo63y8gogj30c61q8446.jpg" action-data="pic_id=005SA0DWgw1evo63y8gogj30c61q8446" action-type="fl_pics" suda-uatrack="key=tblog_newimage_feed&amp;value=image_feed_unfold:3885917867313445:005SA0DWgw1evo63y8gogj30c61q8446">                        </li>
                                                                                                    <li class="WB_pic S_bg2 bigcursor">
                            <img class="bigcursor" src="<?php echo APP_INDEX; ?>common/person/person/005SA0DWgw1evo63z26tvj30c61m2wkm.jpg" action-data="pic_id=005SA0DWgw1evo63z26tvj30c61m2wkm" action-type="fl_pics" suda-uatrack="key=tblog_newimage_feed&amp;value=image_feed_unfold:3885917867313445:005SA0DWgw1evo63z26tvj30c61m2wkm">                        </li>
                                                                                                    <li class="WB_pic S_bg2 bigcursor">
                            <img class="bigcursor" src="<?php echo APP_INDEX; ?>common/person/person/005SA0DWgw1evo63wbijbj30c61k8dm8.jpg" action-data="pic_id=005SA0DWgw1evo63wbijbj30c61k8dm8" action-type="fl_pics" suda-uatrack="key=tblog_newimage_feed&amp;value=image_feed_unfold:3885917867313445:005SA0DWgw1evo63wbijbj30c61k8dm8">                        </li>
                                                                                                    <li class="WB_pic S_bg2 bigcursor">
                            <img class="bigcursor" src="<?php echo APP_INDEX; ?>common/person/person/005SA0DWgw1evo63zkw2oj30c61okwlw.jpg" action-data="pic_id=005SA0DWgw1evo63zkw2oj30c61okwlw" action-type="fl_pics" suda-uatrack="key=tblog_newimage_feed&amp;value=image_feed_unfold:3885917867313445:005SA0DWgw1evo63zkw2oj30c61okwlw">                        </li>
                                                                                                    <li class="WB_pic S_bg2 bigcursor">
                            <img class="bigcursor" src="<?php echo APP_INDEX; ?>common/person/person/005SA0DWgw1evo6401uubj30c61liafj.jpg" action-data="pic_id=005SA0DWgw1evo6401uubj30c61liafj" action-type="fl_pics" suda-uatrack="key=tblog_newimage_feed&amp;value=image_feed_unfold:3885917867313445:005SA0DWgw1evo6401uubj30c61liafj">                        </li>
                                                                                                    <li class="WB_pic S_bg2 bigcursor">
                            <img class="bigcursor" src="<?php echo APP_INDEX; ?>common/person/person/005SA0DWgw1evo640htunj30c61s2n3j.jpg" action-data="pic_id=005SA0DWgw1evo640htunj30c61s2n3j" action-type="fl_pics" suda-uatrack="key=tblog_newimage_feed&amp;value=image_feed_unfold:3885917867313445:005SA0DWgw1evo640htunj30c61s2n3j">                        </li>
                                                                                                                    </ul>
                </div>
                                <!-- /九宫格 -->
                                 </div>
    ...
    <div class="WB_handle W_fr" mid="3885917867313445">
        <ul class="clearfix">
                        <li><span class="line S_line1"><a bpfilter="page_frame" href="http://weibo.com/5387168588/CA37cuGyN?type=repost" class="S_txt2" action-history="rec=1" suda-uatrack="key=feed_trans_weibo&amp;value=transfer:3885917867313445">转发 2260</a></span></li>
            <li><span class="line S_line1"><a bpfilter="page_frame" href="http://weibo.com/5387168588/CA37cuGyN" class="S_txt2" suda-uatrack="key=feed_trans_weibo&amp;value=comment:3885917867313445">评论 74</a></span></li>
            <li><span class="line S_line1"><a href="javascript:void(0);" class="S_txt2" action-type="fl_like" action-data="version=mini&amp;qid=heart&amp;mid=3885917867313445" title="赞"><span node-type="like_status"><i class="W_icon icon_praised_b"></i><em> 521</em></span></a></span></li>
        </ul>
    </div>
	
    <div class="WB_from S_txt2">
        <a class="S_txt2" target="_blank" href="http://weibo.com/5387168588/CA37cuGyN" title="2015-09-11 16:01" date="1441958478000" node-type="feed_list_item_date" suda-uatrack="key=feed_trans_weibo&amp;value=time:3885917867313445">2015-9-11 16:01</a>
         来自 <a class="S_txt2" action-type="app_source" target="_blank" href="http://app.weibo.com/t/feed/4fuyNj" rel="nofollow">即刻笔记</a>    </div>
</div>                                    </div>
            </div>
                                        <div class="WB_tag_s" node-type="feed_list_tagList" style="display: none">
                                        <span class="b" id="q1" style="display:none;">
                                        </span>
                                            <span class="o"><a href="javascript:void(0);" title="编辑这条微博的标签" _taglist="" node-type="feed_list_editTag" action-type="fl_addTag" action-data="mid=3885937941045856"><i class="W_ficon ficon_edit S_ficon">7</i></a></span>
                                    </div>
                          <!-- feed区 大数据tag -->
                        <!-- /feed区 大数据tag -->
            <div class="WB_from S_txt2">
                
                <a name="3885937941045856" target="_blank" href="http://weibo.com/2664098951/CA3DA4o4E?from=page_1005052664098951_profile&wvr=6&mod=weibotime" title="2015-09-11 17:21" date="1441963264000" class="S_txt2" node-type="feed_list_item_date" suda-data="key=tblog_home_new&amp;value=feed_time:3885937941045856"> 2015-9-11 17:21</a>
                 来自                                                                                                         <a class="S_txt2" suda-uatrack="key=profile_feed&amp;value=pubfrom_host" action-type="app_source" target="_blank" href="http://app.weibo.com/t/feed/1tqBja" rel="nofollow">360安全浏览器</a>                                                                                              
            </div>
        </div>
    </div>
    ...
    <div class="WB_feed_handle" node-type="feed_list_options">
        <div class="WB_handle">
            <ul class="WB_row_line WB_row_r4 clearfix S_line2">
                            <li>
                                    <a href="javascript:void(0);" class="S_txt2" action-type="fl_pop" action-data="mid=3885937941045856" suda-uatrack="key=profile_feed&amp;value=popularize_host"><span class="pos"><span class="line S_line1">
                                            <i class="S_txt2" title="此条微博已经被阅读116次">阅读 116</i>&nbsp;
                                                                        推广                                            </span></span>
                    </a>
                                </li>
                                        <li>
                    <a action-data="allowForward=1&amp;rootmid=3885917867313445&amp;rootname=英语必修班&amp;rootuid=5387168588&amp;rooturl=http://weibo.com/5387168588/CA37cuGyN&amp;url=http://weibo.com/2664098951/CA3DA4o4E&amp;mid=3885937941045856&amp;name=江西王红影&amp;uid=2664098951&amp;domain=YYBXB&amp;pid=005SA0DWgw1evo63xgzyxj30c61rg106" action-type="fl_forward" action-history="rec=1" href="javascript:void(0);" class="S_txt2" suda-uatrack="key=profile_feed&amp;value=transfer"><span class="pos"><span class="line S_line1" node-type="forward_btn_text">转发</span></span></a>
                    <span class="arrow"><span class="W_arrow_bor W_arrow_bor_t"><i class="S_line1"></i><em class="S_bg1_br"></em></span></span>
                </li>
                        <li>
                                    <a href="javascript:void(0);" class="S_txt2" action-type="fl_comment" action-data="ouid=2664098951&amp;location=profile&amp;comment_type=1" suda-uatrack="key=profile_feed&amp;value=comment:3885937941045856"><span class="pos"><span class="line S_line1" node-type="comment_btn_text">评论</span></span></a>
                                <span class="arrow"><span class="W_arrow_bor W_arrow_bor_t"><i class="S_line1"></i><em class="S_bg1_br"></em></span></span>
            </li>
            <li>
                <a href="javascript:void(0);" class="S_txt2" action-type="fl_like" action-data="version=mini&amp;qid=heart&amp;mid=3885937941045856&amp;loc=profile" title="赞" suda-uatrack="key=profile_feed&amp;value=like"><span class="pos"><span class="line S_line1"><span node-type="like_status"><i class="W_icon icon_praised_b"></i><em></em></span></span></span></a>
                <span class="arrow"><span class="W_arrow_bor W_arrow_bor_t"><i class="S_line1"></i><em class="S_bg1_br"></em></span></span>
            </li>
            </ul>
        </div>
...
<!--========================================================================================================-->	
		<!-- <div class="WB_cardwrap S_bg2" node-type="lazyload">
            <div class="WB_empty">
                <div class="WB_innerwrap">
                    <div class="empty_con clearfix">
                        <p class="text S_txt2"><i class="W_loading"></i>正在加载中，请稍候...</p>
                    </div>
                </div>
            </div>
        </div> -->
