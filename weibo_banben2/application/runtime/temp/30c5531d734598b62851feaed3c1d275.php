<?php if (!defined('THINK_PATH')) exit();?><form id="pagerForm" action="<?php echo U('Hot/index'); ?>" method="post">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" href="<?php echo U('Hot/add'); ?>" target="dialog" width="550" height="300" rel="gonggaoadd" title="添加友情连接"><span>刷新排行</span></a></li>
			<li><a class="delete" href="<?php echo U('Hot/del'); ?>?id={item_id}&navTabId=linkList" target="ajaxTodo" title="确定要操作吗?"><span>切换状态</span></a></li>
			<li><a class="edit" href="<?php echo U('Hot/edit'); ?>?id={item_id}"  width="550" height="300" target="dialog"><span>修改</span></a></li>
		...
		<tbody>
			<?php foreach($list as $vo): ?>
				<tr target="item_id" rel="<?php echo $vo['id']; ?>">
					...
					<td><?php echo $vo['hot_height']; ?></td>
					<td><?php echo ($vo['status']=='1')?'推荐':'不推荐'; ?></td>
				</tr>
			<?php endforeach; ?>
		</tbody>
	</table>
